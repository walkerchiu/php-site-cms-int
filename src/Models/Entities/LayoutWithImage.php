...
class LayoutWithImage extends Entity
{
    use LangTrait;
    use ImageTrait;
    ...
    {
        $this->table = config('wk-core.table.site-cms.layouts');
    ...
    public function lang()
    {
        if (
            ...
            return config('wk-core.class.site-cms.layoutLang');
        }
    }
    ...
    public function langs()
    {
        if (
            ...
            return $this->hasMany(config('wk-core.class.site-cms.layoutLang'), 'morph_id', 'id');
        }
    }
    ...
    {
        return $this->belongsTo(config('wk-core.class.site-cms.site'), 'site_id', 'id');
    }
