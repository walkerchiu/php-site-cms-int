...
class SiteRepository extends Repository
{
    ...
    {
        $this->instance = App::make(config('wk-core.class.site-cms.site'));
    }
    ...
    public function show($instance, $code): array
    {
        ...
        $data['smtp'] = [
            ...
            'encryption_supported' => config('wk-site-cms.smtp.encryption_supported'),
    ...
    {
        $data = [];
        foreach (config('wk-site-cms.initializer.email') as $key => $type) {
            if ($type['onoff']) {
