...
class EmailSender extends Mailable
{
    ...
    {
        if (config('wk-site-cms.smtp.fixed_sender.onoff'))
            $this->from['email'] = config('wk-site-cms.smtp.fixed_sender.email');

        $email = $this->from($this->from['email'], $this->from['name']);

        return View::exists('vendor.php-site-cms.emails.container') ?
                    $email->view('vendor.php-site-cms.emails.container') :
                    $email->view('php-site-cms::emails.container');
    }
}
