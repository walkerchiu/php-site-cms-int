...
use WalkerChiu\SiteCMS\Models\Constants\LayoutType;
...
use WalkerChiu\SiteCMS\Models\Repositories\LayoutRepository;

class LayoutRepositoryTest extends \Orchestra\Testbench\TestCase
{
    use RefreshDatabase;
    ...
    protected function setUp(): void
    {
        ...
        $this->repository = $this->app->make(LayoutRepository::class);
    }
    ...
    /**
     * A basic functional test on LayoutRepository.
     *
     * For WalkerChiu\Core\Models\Repositories\Repository
     *
     * @return void
     */
    public function testLayoutRepository()
    {
        // Config
        Config::set('wk-core.onoff.core-lang_core', 0);
        Config::set('wk-site-cms.onoff.core-lang_core', 0);
        Config::set('wk-core.lang_log', 1);
        Config::set('wk-site-cms.lang_log', 1);
        Config::set('wk-core.soft_delete', 1);
        Config::set('wk-site-cms.soft_delete', 1);
    ...
    /**
     * Unit test about Lang creation on LayoutRepository.
     *
     * For WalkerChiu\Core\Models\Repositories\RepositoryTrait
     *     WalkerChiu\SiteCMS\Models\Repositories\LayoutRepository
     * 
     * @return void
     */
    public function testcreateLangWithoutCheck()
    {
        ...
        // Give
        factory(Layout::class)->create(['site_id' => $db_site->id]);
        ...
        // Create Lang
            ...
            // Then
            $this->assertInstanceOf(LayoutLang::class, $lang);
    }

    /**
     * Unit test about Enable and Disable on LayoutRepository.
     *
     * For WalkerChiu\Core\Models\Repositories\RepositoryTrait
     *     WalkerChiu\SiteCMS\Models\Repositories\LayoutRepository
     *
    ...
    public function testEnableAndDisable()
    {
        ...
        // Give
        $db_morph_1 = factory(Layout::class)->create(['site_id' => $db_site->id, 'is_enabled' => 1]);
        $db_morph_2 = factory(Layout::class)->create(['site_id' => $db_site->id]);
        $db_morph_3 = factory(Layout::class)->create(['site_id' => $db_site->id]);
        $db_morph_4 = factory(Layout::class)->create(['site_id' => $db_site->id]);
    ...
    /**
     * Unit test about Query List on LayoutRepository.
     *
     * For WalkerChiu\Core\Models\Repositories\RepositoryTrait
     *     WalkerChiu\SiteCMS\Models\Repositories\LayoutRepository
     *
    ...
    /**
     * Unit test about FormTrait on LayoutRepository.
     *
     * For WalkerChiu\Core\Models\Repositories\RepositoryTrait
     *     WalkerChiu\SiteCMS\Models\Repositories\LayoutRepository
    ...
    public function testFormTrait()
    {
        ...
        // Name
            ...
            $db_morph_1 = factory(Layout::class)->create(['site_id' => $db_site->id]);
            $db_morph_2 = factory(Layout::class)->create(['site_id' => $db_site->id]);
            $db_lang_1 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_1->id, 'morph_type' => Layout::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello']);
            $db_lang_2 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_2->id, 'morph_type' => Layout::class, 'code' => 'zh_tw', 'key' => 'name', 'value' => '您好']);
            // When
        ...
        // Serial, Identifier
            // Give
            $db_morph_3 = factory(Layout::class)->create(['serial' => '123', 'identifier' => 'A123', 'site_id' => $db_site->id]);
            $db_morph_4 = factory(Layout::class)->create(['serial' => '124', 'identifier' => 'A124', 'site_id' => $db_site->id]);
            $db_morph_5 = factory(Layout::class)->create(['serial' => '125', 'identifier' => 'A125', 'is_enabled' => 1, 'site_id' => $db_site->id]);
            // When
    ...
    /**
     * Unit test about Auto Complete on LayoutRepository.
     *
     * For WalkerChiu\Core\Models\Repositories\RepositoryTrait
     *     WalkerChiu\SiteCMS\Models\Repositories\LayoutRepository
     *
    ...
    public function testAutoComplete()
    {
        ...
        // Give
        $db_morph_1 = factory(Layout::class)->create(['serial' => 'A123', 'is_enabled' => 1, 'site_id' => $db_site->id]);
        $db_morph_2 = factory(Layout::class)->create(['serial' => 'A124', 'is_enabled' => 1, 'site_id' => $db_site->id]);
        $db_lang_1 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_1->id, 'morph_type' => Layout::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello']);
        $db_lang_1 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_1->id, 'morph_type' => Layout::class, 'code' => 'en_us', 'key' => 'description', 'value' => 'Good Morning!']);
        $db_lang_1 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_1->id, 'morph_type' => Layout::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello World']);
        $db_lang_1 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_1->id, 'morph_type' => Layout::class, 'code' => 'zh_tw', 'key' => 'name', 'value' => '您好']);
        $db_lang_1 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_1->id, 'morph_type' => Layout::class, 'code' => 'zh_tw', 'key' => 'name', 'value' => '早安']);
        $db_lang_2 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_2->id, 'morph_type' => Layout::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Bye']);
